...
export default class eventLocation
{
    async getEventLocationsByUser(id_creator_user, limit, offset) {
        ...
        const cantidad = Number.parseInt(await EventLocation.countEventLocations()); // cant total event_locations from usuario
        const pagination = PaginacionConfig.buildPaginationDto(parsedLimit, parsedOffset, cantidad, "/event-location"); // buildup paginación
        ...
        async getEventLocationsById(id_creator_user, id, limit, offset) {
            ...
            const pagination = PaginacionConfig.buildPaginationDto(parsedLimit, parsedOffset, cantidad, nextPage); // buildup paginación
