...
router.get("/", async (request, response) => {
  ...
  router.get("/:id/enrollment", async(request,response) =>{ //El respectivo
  ...
  router.post("/",authMiddleware,async(request, response) => {  //Labura postmann
    const Evento = {};
...
router.put("/",authMiddleware,async(request, response) => {  //agarra la pala el respectivo
  const Evento = {};
  Evento.name = request.body.name;
  Evento.description = request.body.description;
  Evento.id_event_category = request.body.id_event_category
